...
IrrlichtDevice *startup(android_app* app)
{
	...
	*/
	...
	LOGI("marky startup 0 ");
	return createDeviceEx(param);
	//return createDevice( video::EDT_OGLES2,core::dimension2d<u32>(ANativeWindow_getWidth(app->window), ANativeWindow_getHeight(app->window)), //TODO[reizen]: doesn't work at the moment, always max resolution
    //       								16,
    //       								false,
    //      								false,
    //       								false,
...
{
	LOGI("marky example_helloworld 0 ");
	// create device
	IrrlichtDevice *device = startup(app);
	if (device == 0)
       	return 1;
    LOGI("marky example_helloworld 1 ");
	MyEventReceiver receiver(device);
	device->setEventReceiver(&receiver);


	LOGI("marky example_helloworld 2 ");
	...
	*/
	LOGI("marky example_helloworld 3 ");
	...
	LOGI("marky example_helloworld 4 ");
	...
	*/
	LOGI("marky example_helloworld 5 ");
	...
	/* Your media must be somewhere inside the assets folder. The assets folder is the root for the file system.
   	...
   	LOGI("marky example_helloworld 6 ");
	...
	LOGI("marky example_helloworld 7 ");
	...
	LOGI("marky example_helloworld 8 ");
	// add irrlicht logo
    ...
    LOGI("marky example_helloworld 9 ");
	// Add a 3d model
	...
	*/
	...
	LOGI("marky example_helloworld 10 ");
	...
	*/
	...
	LOGI("marky example_helloworld 11 ");
...
void android_main(android_app* app)
{
	...
	LOGI("marky android_main 0 ");
	app_dummy();

	LOGI("marky android_main 1 ");
	example_helloworld(app);

	LOGI("marky android_main 2 ");
}
