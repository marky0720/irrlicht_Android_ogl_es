...
LOCAL_MODULE    := CustomSceneNode
#LOCAL_MODULE_FILENAME := libCustomSceneNode
#LOCAL_ARM_MODE := arm
...
LOCAL_C_INCLUDES := \
	...
	$(LOCAL_PATH)/Android \
	$(LOCAL_PATH)/../include \
	$(LOCAL_PATH)/CustomSceneNode_Android \
  
LOCAL_SRC_FILES := CustomSceneNode_Android/main.cpp CustomSceneNode_Android/android_tools.cpp
