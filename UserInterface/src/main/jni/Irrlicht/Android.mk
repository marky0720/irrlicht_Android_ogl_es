...
#LOCAL_MODULE_FILENAME := libUserInterface
#LOCAL_ARM_MODE := arm
...
LOCAL_C_INCLUDES := \
	...
	$(LOCAL_PATH)/Android \
	$(LOCAL_PATH)/../include \
	$(LOCAL_PATH)/UserInterface_Android \
  
LOCAL_SRC_FILES := UserInterface_Android/main.cpp UserInterface_Android/android_tools.cpp
